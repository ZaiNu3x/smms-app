...
public class ForgotPasswordFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        emailOtpEditTxt = view.findViewById(R.id.fgpEmailOtpEditTxt);
        smsOtpEditTxt = view.findViewById(R.id.fgpSmsOtpEditTxt);
        ...
        Button submit = view.findViewById(R.id.fgpSubmitOtpBtn);
    ...
    public void verifyOtp(JSONObject token) {
        final String URL = "https://192.168.1.254:443/forgot-password/verify-otp";
