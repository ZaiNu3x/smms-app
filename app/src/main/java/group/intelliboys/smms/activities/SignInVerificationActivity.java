...
public class SignInVerificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        emailOtpEditTxt = findViewById(R.id.tfaEmailOtpEditTxt);
        smsOtpEditTxt = findViewById(R.id.tfaSmsOtpEditTxt);
        resendEmailOtpLbl = findViewById(R.id.tfaResendEmailOtpLbl);
        resendSmsOtpLbl = findViewById(R.id.tfaResendSmsOtpLbl);
        emailOtpTimer = findViewById(R.id.tfaEmailOtpTimer);
        smsOtpTimer = findViewById(R.id.tfaSmsOtpTimer);
        okHttpClient = CustomOkHttpClient.getOkHttpClient(getApplicationContext());
        Button submitBtn = findViewById(R.id.tfaSubmitBtn);
